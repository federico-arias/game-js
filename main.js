...
var Entity = exports.Entity = function () {
	...
	_createClass(Entity, [{
		...
		key: 'draw',
		value: function draw() {
			if (this.currSpriteName) (0, _Spritesheet.getSprite)(this.currSpriteName).draw(this.x, this.y);
		}
		...
		key: 'onTouch',
		value: function onTouch(entity, _, impulse) {}
	}]);
...
var Game = exports.Game = function () {
	function Game(map, physics, input, clock) {
	...
	_createClass(Game, [{
		...
		value: function frame() {
			...
			this.update(delta);
			if (delta > 0.16) {
				//TODO replace with PHYSICS_INTERVAL
...
var GameMap = exports.GameMap = function () {
	function GameMap(jsonPath, render) {
		...
		this.mapa = (0, _fetch.get)(jsonPath).then(function (m) {
			_this.tileW = m.tilewidth;
			_this.tileH = m.tileheight;
			_this.layers = m.layers;
			_this.w = m.tilewidth * m.width;
			_this.h = m.tileheight * m.height;
			return m;
		});
		this.ready = this.mapa.then(this.parseTilesets.bind(this)).then(this.cacheMegaTiles.bind(this));
	}

	_createClass(GameMap, [{
		key: 'cacheMegaTiles',
		value: function cacheMegaTiles() {
			var nMegaTilesInX = 1 + Math.floor(this.w / this.MEGATILE_W);
			var nMegaTilesInY = 1 + Math.floor(this.h / this.MEGATILE_H);
			var nMegaTiles = nMegaTilesInX * nMegaTilesInY;
		...
		key: 'fillMegaTile',
		value: function fillMegaTile(mtile) {
			var _this2 = this;
     ...
     */
				...
				return acc.then(function (_) {
					return dat.reduce(function (acc, tId, i, a) {
						if (tId == 0) return acc;
						//figure out the position of small tile in the world
						var worldX = Math.floor(i % layer.width) * _this2.tileW;
						var worldY = Math.floor(i / layer.width) * _this2.tileH;
						//figure out if the megatile rectangle intersects with the small tile
						var visible = GameMap.areIntersecting(y0, worldY, y1, worldY + layer.tileheight, x0, worldX, x1, worldX + layer.tilewidth);
						if (!visible) return acc;
						var tile = _this2.findTileset(tId).findTile(tId);
						return acc.then(function (_) {
							return tile.img.then(function (_) {
								return ctx2.drawImage(tile.i, tile.x, tile.y, _this2.tileW, _this2.tileH, worldX - x0, // tiles are drawn in 
   ...
   */
		...
		key: 'findTileset',
		value: function findTileset(gid) {
		...
		key: 'areIntersecting',
		value: function areIntersecting(top0, top1, bottom0, bottom1, left0, left1, right0, right1) {
...
var MegaTile = function () {
	function MegaTile(width, height) {
		_classCallCheck(this, MegaTile);
	...
	_createClass(MegaTile, [{
		key: 'isVisibleIn',
		value: function isVisibleIn(r2) {
			var r1 = this;
			return GameMap.areIntersecting(r1.y, r2.y, r1.x, r2.x, r1.x + r1.w, r2.x + r2.w, r1.y + r1.h, r2.y + r2.h);
		}
	}]);
...
var Input = exports.Input = function () {
	...
	_createClass(Input, [{
		...
		value: function onKeyDown(ev) {
			...
			if (typeof action != 'undefined') this.actions[action] = true;
		}
	}, {
		key: 'onKeyUp',
		...
		value: function getStateName() {
			...
			return Object.keys(this.actions).filter(function (action) {
				return _this.actions[action];
			})[0];
		}
	}, {
		key: 'setBinding',
		value: function setBinding(key, action) {
...
var Physics = exports.Physics = function () {
	...
	_createClass(Physics, [{
		...
		key: 'createBody',
		value: function createBody(entityDef) {
...
var Player = exports.Player = function (_Entity) {
	...
	function Player(x, y, physics, input) {
		...
		value: function update() {
			...
			switch (this.input.getStateName()) {
				case 'move-right':
					...
					this.body.SetLinearVelocity(_Physics.Physics.goRight());
					break;
				case 'move-down':
					this.currSpriteNamesIterator = this.walkRightAnimation;
				...
				case 'move-up':
					this.currSpriteNamesIterator = this.walkRightAnimation;
					this.body.SetLinearVelocity(_Physics.Physics.goUp());
					break;
				default:
					this.isMoving = false;
					this.body.SetLinearVelocity(_Physics.Physics.stand());
			}
			//move iterator forward
			if (this.isMoving) this.currSpriteName = this.currSpriteNamesIterator.next();
		}
	}, {
		key: 'onTouch',
		value: function onTouch(otherBody, point, impulse) {
...
var Render = exports.Render = function () {
	...
	_createClass(Render, [{
		...
		key: 'draw2x',
		value: function draw2x(image, sx, sy, w, h, wx, wy) {
...
exports.getSprite = exports.SpriteNamesIterable = exports.Spritesheet = undefined;
...
var Spritesheet = exports.Spritesheet = function () {
	function Spritesheet(imgUri, jsonUri, renderer) {
		var _this = this;

		_classCallCheck(this, Spritesheet);

		this.render = renderer;
		var json = (0, _fetch.get)(jsonUri);
		this.img = new Image();
		this.img.src = imgUri;
		this.p = new Promise(function (r) {
			return _this.img.onload = function (_) {
				return r(_);
			};
		});
	...
	_createClass(Spritesheet, [{
		...
		value: function parseSpritesheet(json) {
...
var SpriteNamesIterable = exports.SpriteNamesIterable = function () {
	function SpriteNamesIterable(name, first, last, single) {
		_classCallCheck(this, SpriteNamesIterable);
	...
	_createClass(SpriteNamesIterable, [{
		key: '__iter__',
		value: function __iter__(speed) {
...
var Sprite = function () {
	...
	_createClass(Sprite, [{
		...
		value: function draw(x, y) {
			this.rdr.draw(this.sheet, this.spriteX, this.spriteY, this.w, this.h, x - this.hw, y - this.hh);
		}
	}]);
...
var _PlayerEntity = require('./PlayerEntity.js');
